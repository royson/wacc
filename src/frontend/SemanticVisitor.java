...
public class SemanticVisitor extends WACCParserBaseVisitor<Void> {
  ...
  private String[] primitiveTypes = { "INT", "BOOL", "CHAR", "CHAR[]" };
  ...
  public Void visitPrintstatement(WACCParser.PrintstatementContext ctx) {
	if (DEBUG) {
  ...
  public Void visitWhilestatement(WACCParser.WhilestatementContext ctx) {
	if (DEBUG) {
  ...
  public Void visitStatementblock(WACCParser.StatementblockContext ctx) {
	if (DEBUG) {
  ...
  public Void visitBooleanliteral(WACCParser.BooleanliteralContext ctx) {
	if (DEBUG) {
  ...
  public Void visitBinaryoperator(WACCParser.BinaryoperatorContext ctx) {
	if (DEBUG) {
